    ...
    const tutorialScriptForPC: IStep[] = [
        {
            ...
            text: `Welcome to the tutorial! Let's start by crafting {{planks}}, like in Minecraft. {{Pick up}} any type of {{log}} and {{drop it}} on the {{crafting table}} with the {{${settings?.controls.copy} key}}. If you put too much materials on the crafting table, you can {{remove it}} with the {{${settings?.controls.remove} key}}.`,
        ...
        },
        {
            guess: "axe0",
            requiredControl: [],
            text: `So now you might be confused. How can a {{riddle}} contain and not contain the same material at the same time? The answer is simple: in the game some recipes are in a "{{recipe group}}". For example {{swords}}. {{Wooden sword}} and {{iron sword}} has the same recipe, but with different materials, so they are in a {{recipe group}}. So the {{riddle}} can be some kind of tool. Let's try to craft an {{axe}}.`,
    ...
    const tutorialScriptForMobile: IStep[] = [
        {
            guess: "planks0",
            requiredControl: [],
            text: `Welcome to the tutorial! Let's start by crafting {{planks}}, like in Minecraft. {{Select}} any type of {{log}} and {{place it}} on the {{crafting table}}. If you put too much materials on the crafting table, you can {{remove it}} by tap on it.`,
            help: `You have to {{select}} a {{log}} and {{place it}} on the {{crafting table}}, to craft {{planks}}.`
        },
        {
            guess: "armorStand0",
            requiredControl: [],
            text: `Great! How you can see, there is no {{wood}} and {{log}} in the {{riddle}}. Let's craft an {{armor stand}}. Select the {{stick}} and {{place them}} on {{crafting table}}. If you don't know how to craft an item, you can look it up in the {{recipe book}}.`,
            help: `You have to {{place}} the {{materials}} on the {{crafting table}}, to craft an {{armor stand}}.`
        },
        {
            guess: "rail0",
            requiredControl: [],
            text: `Good job! Now we know there are two {{sticks}} in the {{riddle}} and we know one of it's place. Let's craft a {{rail}} to see if there are any {{iron ingonts}} in the {{riddle}}. {{Place}} the materials on the crafting table.`,
            help: `You have to {{place}} the {{materials}} on the {{crafting table}}, to craft a {{rail}}.`
        },
        {
            guess: "piston0",
